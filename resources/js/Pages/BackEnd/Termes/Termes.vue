...
const form = useForm({
    title: props.termes?.title || "",
    description: props.termes?.description || "",
});

const submit = () => {
    form.post(route("termes.store"), {
        preserveScroll: true,
    });
};
</script>
    ...
    <Layout>
        <div class="max-w-4xl mx-auto bg-white p-6 rounded shadow">
            <h1 class="text-2xl font-bold mb-4">
                {{ termes ? "Update Termes Page" : "Create Termes Page" }}
            </h1>
